package com.okecode.parking_detector_plugin.core
...
object Constants {
    ...
    // Intents y acciones
    const val ACTION_START_SERVICE = "com.okecode.where_is_it.START_SERVICE"
    const val ACTION_STOP_SERVICE = "com.okecode.where_is_it.STOP_SERVICE"
    const val ACTION_ACTIVITY_TRANSITION_UPDATE = "com.okecode.where_is_it.ACTIVITY_TRANSITION_UPDATE"
    ...
    // Broadcast actions
    const val ACTION_PARKING_STATE_CHANGED = "com.okecode.where_is_it.ACTION_PARKING_STATE_CHANGED"
